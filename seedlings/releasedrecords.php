...
function isDashboardActive() {
    $dashboardPages = [
        'incoming.php' => '',
        'receivedrecords.php' => '',
        'plantablerecords.php' => '',
        'releasedrecords.php' => 'active', // This will be the active page
        'discardedrecords.php' => '',
        'balancerecords.php' => '',
        'allrecords.php' => ''
    ];
    $currentPage = basename($_SERVER['PHP_SELF']);
    return $dashboardPages[$currentPage] ?? '';
}
...
<head>
    ...
    <link rel="stylesheet" href="/denr/superadmin/css/releasedrecords.css">
     <link rel="stylesheet" href="/denr/superadmin/js/releasedrecords.js">
            ...
            <div class="nav-icon active">
                ...
                <div class="dropdown-menu center">
                 ...
                 <a href="incoming.php" class="dropdown-item">
                    ...
                    <a href="releasedrecords.php" class="dropdown-item active-page">
    ...
    <div class="CHAINSAW-RECORDS">
        <div class="container">
            <div class="header" style="background: #ffffff; border-radius: 12px; padding: 18px 20px; box-shadow: 0 6px 15px rgba(0,0,0,0.2); margin-bottom: 30px; color: black;">
                ...
                <h1 class="title">SEEDLINGS RELEASED </h1>
            </div>
    ...
    <span class="export-label">Export as CSV</span>
            ...
            <div class="table-container">
                <table class="accident-table">
                    <thead>
                        <tr>
                            <th>RELEASED <br>ID</th>
                            
                            <th>SEEDLING <br>NAME</th>
                            <th>NO. OF SEEDLINGS <br>AVAILED</th>
                            <th>DATE DISPOSED</th>
                            <th>LOCATION OF PLANTING SITE</th>
                            <th>NAME OF PARTNER/REQUESTING PARTNER</th>
                            <th>REASON</th>
                            <th>ACTIONS</th>
                        </tr>
                    </thead>
