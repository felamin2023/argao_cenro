...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
     ...
     <link rel="stylesheet" href="/denr/superadmin/css/discardedrecords.css">
     <link rel="stylesheet" href="/denr/superadmin/js/discardedrecords.js">
...
<header>
            ...
            <div class="nav-icon active">
                ...
                <div class="dropdown-menu center">
                  ...
                  <a href="incoming.php" class="dropdown-item">
                    ...
                    <a href="discardedrecords.php" class="dropdown-item active-page">
    ...
    <div class="header" style="background: #ffffff; border-radius: 12px; padding: 18px 20px; box-shadow: 0 6px 15px rgba(0,0,0,0.2); margin-bottom: 30px; color: black;">
                <h1 class="title">SEEDLINGS DISCARDED</h1>
            </div>
