...
/**
 * User-only gate for species.php
...
try {
    ...
    error_log('[SPECIES GUARD] ' . $e->getMessage());
    header('Location: user_login.php');
    exit();
}
...
try {
    ...
    error_log('[SPECIES NOTIFS] ' . $e->getMessage());
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Coastal and Marine Species Monitoring</title>
