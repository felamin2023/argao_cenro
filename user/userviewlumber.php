    ...
    <div class="main-container">
        ...
        <div class="requirements-form">
            <div class="form-header">
                <h2>Lumber Dealers Permit - View Requirements</h2>
            </div>
                ...
                <div class="summary-section">
                    ...
                    <div class="summary-grid">
                        ...
                        <div class="summary-item">
                            ...
                            <div class="summary-item-value">LD-2022-0456</div>
                        </div>
                        <div class="summary-item">
            ...
            <div class="applicant-info-value">Cruz</div>
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">log.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>3.1 MB</span>
                                        </div>
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">application.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>2.4 MB</span>
                                        </div>
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">business.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>3.1 MB</span>
                                        </div>
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">certificate.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>3.1 MB</span>
                                        </div>
                ...
                <!-- Requirement 8-->
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">income.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>3.1 MB</span>
                                        </div>
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            <h4 class="uploaded-files-title"><i class="fas fa-paperclip"></i>- Photocopy of Official Receipt</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                            ...
                            <h4 class="uploaded-files-title" style="margin-top: 20px;"><i class="fas fa-paperclip"></i>- Photocopy of Order of Payment</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">order.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.7 MB</span>
                                        </div>
