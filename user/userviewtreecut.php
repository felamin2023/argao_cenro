...
<header>
    ...
    <div class="main-container">
        <div class="action-buttons">
            <a href="useraddtreecut.php" class="btn btn-outline">
        ...
        <div class="requirements-form">
            <div class="form-header">
                <h2>Tree Cutting Permit - View Requirements</h2>
            </div>
                ...
                <div class="summary-section">
                    ...
                    <div class="summary-item">
                        ...
                        <div class="summary-item">
                            ...
                            <div class="summary-item-value">TCP-2022-0456</div>
                        </div>
                        <div class="summary-item">
            ...
            <div class="applicant-info-value">Cruz</div>
                ...
                <div class="requirements-list">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">purchase_order.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>2.4 MB</span>
                                        </div>
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            <h4 class="uploaded-files-title"><i class="fas fa-paperclip"></i> Photocopy of OR/CR of conveyance</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Photocopy.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.3 MB</span>
                                        </div>
                            ...
                            <h4 class="uploaded-files-title" style="margin-top: 20px;"><i class="fas fa-paperclip"></i> Photocopy of Drivers License</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Driver_License.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.7 MB</span>
                                        </div>
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">letter_request.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>3.1 MB</span>
                                        </div>
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            <h4 class="uploaded-files-title"><i class="fas fa-paperclip"></i>- Tally sheets and stand/ stock table</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Tally_sheets.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.3 MB</span>
                                        </div>
                            ...
                            <h4 class="uploaded-files-title" style="margin-top: 20px;"><i class="fas fa-paperclip"></i>- Tree Charting<</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Tree_Charting.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.7 MB</span>
                                        </div>
