    ...
    <div class="main-container">
        ...
        <div class="requirements-form">
            <div class="form-header">
                <h2>Wildlife Farm Permit - View Requirements</h2>
            </div>
                ...
                <div class="summary-section">
                    ...
                    <div class="summary-grid">
                        ...
                        <div class="summary-item">
                            ...
                            <div class="summary-item-value">WFP-2023-0456</div>
                        </div>
                        <div class="summary-item">
            ...
            <div class="applicant-info-value">Cruz</div>
                ...
                <div class="requirements-list">
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                ...
                                <div class="file-card">
                                    <div class="file-preview">
                                        <img src="https://via.placeholder.com/300x200?text=Applicant+Photo" alt="Applicant Photo">
                                    </div>
                                    <div class="file-details">
                                        <div class="file-name">Applicant_Photo.jpg</div>
                                        <div class="file-meta">
                                            <span>JPG</span>
                                            <span>1.2 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Applicant_Photo.jpg">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">SEC_Registration.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>3.1 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="SEC_Registration.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Veterinary_Certificate.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.8 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Veterinary_Certificate.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Financial_Plan.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>2.7 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Financial_Plan.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                                ...
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Bank_Statement.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.5 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Bank_Statement.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <img src="https://via.placeholder.com/300x200?text=Facility+Design" alt="Facility Design">
                                    </div>
                                    <div class="file-details">
                                        <div class="file-name">Facility_Design.jpg</div>
                                        <div class="file-meta">
                                            <span>JPG</span>
                                            <span>2.8 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Facility_Design.jpg">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                                ...
                                <div class="file-card">
                                    <div class="file-preview">
                                        <img src="https://via.placeholder.com/300x200?text=Facility+Photo" alt="Facility Photo">
                                    </div>
                                    <div class="file-details">
                                        <div class="file-name">Facility_Photo.jpg</div>
                                        <div class="file-meta">
                                            <span>JPG</span>
                                            <span>3.2 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Facility_Photo.jpg">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Barangay_Clearance.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.1 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Barangay_Clearance.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <img src="https://via.placeholder.com/300x200?text=Vicinity+Map" alt="Vicinity Map">
                                    </div>
                                    <div class="file-details">
                                        <div class="file-name">Vicinity_Map.jpg</div>
                                        <div class="file-meta">
                                            <span>JPG</span>
                                            <span>2.5 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Vicinity_Map.jpg">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                    ...
                    <div class="requirement-item">
                        ...
                        <div class="uploaded-files-container">
                            <h4 class="uploaded-files-title"><i class="fas fa-paperclip"></i> Proof of Purchase (Official Receipt/Deed of Sale or Captive Bred Certificate)</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Proof_of_Purchase.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.3 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Proof_of_Purchase.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                            ...
                            <h4 class="uploaded-files-title" style="margin-top: 20px;"><i class="fas fa-paperclip"></i> Deed of Donation with Notary</h4>
                            <div class="uploaded-files">
                                <div class="file-card">
                                    <div class="file-preview">
                                        <i class="fas fa-file-pdf file-icon"></i>
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Deed_of_Donation.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>1.7 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Deed_of_Donation.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
                        ...
                        <div class="uploaded-files-container">
                            ...
                            <div class="uploaded-files">
                                <div class="file-card">
                                    ...
                                    <div class="file-details">
                                        <div class="file-name">Inspection_Report.pdf</div>
                                        <div class="file-meta">
                                            <span>PDF</span>
                                            <span>2.9 MB</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="Inspection_Report.pdf">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="file-action-btn">
                                                <i class="fas fa-download"></i> Download
