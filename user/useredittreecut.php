...
<header>
        ...
        <div class="nav-container">
            ...
            <div class="nav-item dropdown">
                <div class="nav-icon active">
                    ...
                    <a href="user_treecutting.php" class="dropdown-item active-page">
                        <i class="fas fa-tree"></i>
                        <span>Tree Cutting Permit</span>
                    </a>
                    <a href="user_lumberdealers.php" class="dropdown-item">
                        <i class="fas fa-boxes"></i>
                        <span>Lumber Dealers Permit</span>
                    </a>
                    <a href="user_woodprocessing.php" class="dropdown-item">
                        <i class="fas fa-industry"></i>
                        <span>Wood Processing Permit</span>
                    </a>
                    
                    <a href="user_registered_chainsaw.php" class="dropdown-item">
    ...
    <div class="main-container">
        <div class="action-buttons">
            ...
            <a href="useredittreecut.php"  class="btn btn-primary">
        ...
        <div class="requirements-form edit-mode" id="requirementsForm">
            <div class="form-header">
                <h2>Tree Cutting Permit - Edit Requirements</h2>
            </div>
                            ...
                            <div class="sub-requirement">
                                ...
                                <div class="uploaded-files">
                                    ...
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>transport_agreement.pdf</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            permitTypeBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Here you would typically show/hide different requirements
                    // based on whether it's a new permit or renewal
                    console.log('Selected permit type:', this.dataset.type);
                });
            });
