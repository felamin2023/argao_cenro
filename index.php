    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            align-items: center;
            background: url('user/images/waterfall.jpg') center/cover no-repeat;
            position: relative;
            overflow: hidden;
        }
...
<body>
    ...
    <div class="form-container">
        ...
        <form id="registerForm" action="backend/register.php" method="POST" autocomplete="off">
            ...
            <div class="form-footer">
                <p>Already have an account? <a href="user/user_login.php">Login</a></p>
            </div>
        </form>
    </div>
    ...
    <div class="success-message" id="successMessage" style="display:none;">
        <div class="message-content">
            ...
            <a href="user/user_login.php">OKAY</a>
        </div>
    </div>
