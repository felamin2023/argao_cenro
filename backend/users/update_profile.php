...
if ($password) {
    ...
    $stmt->bind_param('sssssssi', $image_filename, $first_name, $last_name, $age, $email, $phone, $hashed_password, $user_id);
} else {
    // , $department
    $stmt->bind_param('ssssssi', $image_filename, $first_name, $last_name, $age, $email, $phone, $user_id);
}
