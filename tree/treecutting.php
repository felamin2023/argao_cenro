...
<header>
    ...
    <div class="nav-container">
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu center">
                <a href="treecutting.php" class="dropdown-item active-page">
    ...
    <div class="wood-processing-records">
        <div class="container">
            <div class="header">
                <h1 class="title">TREE CUTTING PERMIT RECORDS</h1>
            </div>
    ...
    <div id="detailModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">TREE CUTTING - SUBMITTED REQUIREMENTS</h2>
    ...
    <div id="filePreviewModal" class="modal">
        ...
        const recordData = {
            '1': {
                ...
                'STATUS': 'active',
                'requirements': {
                    'transport_agreement': { uploaded: true, file: 'transport_agreement.pdf' },
                    'or_cr': { uploaded: true, file: 'or_cr.pdf' },
                    'drivers_license': { uploaded: true, file: 'drivers_license.pdf' },
                    'purchase_order': { uploaded: true, file: 'purchase_order.pdf' },
                    'letter_request': { uploaded: true, file: 'letter_request.pdf' },
                    'approved_permit': { uploaded: true, file: 'approved_permit.pdf' },
                    'tally_sheets': { uploaded: true, file: 'tally_sheets.pdf' },
                    'tree_charting': { uploaded: true, file: 'tree_charting.pdf' },
                    'ecc': { uploaded: true, file: 'ecc.pdf' },
                    'cov': { uploaded: true, file: 'cov.pdf' },
                    'payment_receipt': { uploaded: true, file: 'payment_receipt.pdf' },
                    'memorandom_report': { uploaded: true, file: 'memorandom_report.pdf' },
                    'tally_sheets_forest': { uploaded: true, file: 'tally_sheets_forest.pdf' },
                    'geo_photos': { uploaded: true, file: 'geo_photos.pdf' },
                    'sworn_statement': { uploaded: true, file: 'sworn_statement.pdf' },
                }
            }
        };
        ...
        function openModal(id, mode) {
            ...
            modalTitle.textContent = mode === 'edit' ? 
                'EDIT TREE CUTTING' : 
                'TREE CUTTING - SUBMITTED REQUIREMENTS';
                    ...
                    <div class="requirements-list">
                                ...
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            ...
                                            <span>${record.requirements?.cov?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.cov?.file || ''}" title="View">
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.payment_receipt?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.payment_receipt?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.memorandom_report?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.memorandom_report?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.tally_sheets_forest?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.tally_sheets_forest?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.geo_photos?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.geo_photos?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.sworn_statement?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.sworn_statement?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                        ...
                        <div class="requirement-item">
                            ...
                            <div class="file-upload">
                                <div class="sub-requirement" style="margin-top: 15px;">
                                    ...
                                    <div class="uploaded-files">
                                        <div class="file-item">
                                            <div class="file-info">
                                                <i class="fas fa-file-pdf file-icon"></i>
                                                <span>${record.requirements?.or_cr?.file || 'Not uploaded'}</span>
                                            </div>
                                            <div class="file-actions">
                                                <button class="file-action-btn view-file" data-file="${record.requirements?.or_cr?.file || ''}" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="file-action-btn" title="Download">
                                                    <i class="fas fa-download"></i>
                                ...
                                <div class="sub-requirement" style="margin-top: 15px;">
                                    <p style="margin-bottom: 10px; font-weight: 500;">- Photocopy of Driver's License</p>
                                    <div class="uploaded-files">
                                        <div class="file-item">
                                            <div class="file-info">
                                                <i class="fas fa-file-pdf file-icon"></i>
                                                <span>${record.requirements?.drivers_license?.file || 'Not uploaded'}</span>
                                            </div>
                                            <div class="file-actions">
                                                <button class="file-action-btn view-file" data-file="${record.requirements?.drivers_license?.file || ''}" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="file-action-btn" title="Download">
                                                    <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.purchase_order?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.purchase_order?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.letter_request?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.letter_request?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                                ...
                                <div class="sub-requirement" style="margin-top: 15px;">
                                    ...
                                    <div class="uploaded-files">
                                        <div class="file-item">
                                            <div class="file-info">
                                                <i class="fas fa-file-pdf file-icon"></i>
                                                <span>${record.requirements?.tally_sheets?.file || 'Not uploaded'}</span>
                                            </div>
                                            <div class="file-actions">
                                                <button class="file-action-btn view-file" data-file="${record.requirements?.tally_sheets?.file || ''}" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="file-action-btn" title="Download">
                                                    <i class="fas fa-download"></i>
                                ...
                                <div class="sub-requirement" style="margin-top: 15px;">
                                    ...
                                    <div class="uploaded-files">
                                        <div class="file-item">
                                            <div class="file-info">
                                                <i class="fas fa-file-pdf file-icon"></i>
                                                <span>${record.requirements?.tree_charting?.file || 'Not uploaded'}</span>
                                            </div>
                                            <div class="file-actions">
                                                <button class="file-action-btn view-file" data-file="${record.requirements?.tree_charting?.file || ''}" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="file-action-btn" title="Download">
                                                    <i class="fas fa-download"></i>
