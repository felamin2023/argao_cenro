...
try {
    ...
    error_log('[TREE PROFILE READ] ' . $e->getMessage());
    $user = null;
}

if (!$user || strtolower((string)$user['department']) !== 'tree cutting') {
    header('Location: ../superlogin.php');
    exit();
}
...
<head>
    ...
    <title>Tree Cutting Admin Profile</title>
