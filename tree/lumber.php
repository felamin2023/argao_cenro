...
<header>
    ...
    <div class="nav-container">
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu center">
                ...
                <a href="lumber.php" class="dropdown-item active-page">
    ...
    <div class="wood-processing-records">
        <div class="container">
            <div class="header">
                <h1 class="title">LUMBER DEALERS PERMIT RECORDS</h1>
            </div>
    ...
    <div id="detailModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">LUMBER DEALERS - SUBMITTED REQUIREMENTS</h2>
                ...
                html = `
                    <div class="requirements-list">
                                ...
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            ...
                                            <span>${record.requirements?.csw?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.csw?.file || ''}" title="View">
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.geo_pictures?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.geo_pictures?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.supply_contract?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.supply_contract?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.mayors_permit?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.mayors_permit?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.registration_cert?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.registration_cert?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                        ...
                        <div class="requirement-item">
                            <div class="requirement-header">
                                <div class="requirement-title">
                                    <span class="requirement-number">${record.TYPE === 'New Permit' ? '8' : '7'}</span>
                            ...
                            <div class="file-upload">
                                <div class="uploaded-files">
                                    <div class="file-item">
                                        <div class="file-info">
                                            <i class="fas fa-file-pdf file-icon"></i>
                                            <span>${record.requirements?.tax_return?.file || 'Not uploaded'}</span>
                                        </div>
                                        <div class="file-actions">
                                            <button class="file-action-btn view-file" data-file="${record.requirements?.tax_return?.file || ''}" title="View">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <button class="file-action-btn" title="Download">
                                                <i class="fas fa-download"></i>
                        ...
                        <div class="requirement-item">
                            <div class="requirement-header">
                                <div class="requirement-title">
                                    <span class="requirement-number">${record.TYPE === 'New Permit' ? '9' : '8'}</span>
                                    Regulatory Fees
                                </div>
                            </div>
                            <div class="file-upload">
                                ...
                                <div class="sub-requirement" style="margin-top: 15px;">
                                    ...
                                    <div class="uploaded-files">
                                        <div class="file-item">
                                            <div class="file-info">
                                                <i class="fas fa-file-pdf file-icon"></i>
                                                <span>${record.requirements?.payment_order?.file || 'Not uploaded'}</span>
                                            </div>
                                            <div class="file-actions">
                                                <button class="file-action-btn view-file" data-file="${record.requirements?.payment_order?.file || ''}" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="file-action-btn" title="Download">
                                                    <i class="fas fa-download"></i>
